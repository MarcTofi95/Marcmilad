...
const STRING_COLUMNS = [
  'companyName', 'contactPerson', 'contactEmail', 'hoofdspotLength', 'impressions',
  ...
  'cta', 'slogan', 'variationDetail', 'generatedScript', 'generatedVarScript', 'scriptSource',
...
async function memSaveGeneratedScript(id, { main, variation, source }) {
  ...
  row.scriptGeneratedAt = new Date().toISOString();
  row.editedScript = null;
  row.editedVarScript = null;
